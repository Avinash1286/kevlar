...
export const securityDecisionValidator = v.union(
  v.literal("allowed"),
  v.literal("denied"),
);
export const secretStatusValidator = v.union(
  v.literal("active"),
  v.literal("rotating"),
  v.literal("retired"),
);
...
export const routerStatusValidator = v.union(
...
export const chaosOutcomeValidator = v.union(
  v.literal("pass"),
  v.literal("fail"),
);
