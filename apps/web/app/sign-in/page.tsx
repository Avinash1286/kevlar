...
export default function SignInPage() {
  ...
  return <main className="console-shell auth-console">
    ...
    <section className="auth-panel">
      ...
      {isAuthenticated ? <article><span>SESSION ACTIVE</span><h2>You are signed in.</h2><p>Your organization role is checked again on every protected Convex function.</p><button onClick={() => void signOut()}>Sign out</button></article> : <form onSubmit={submit}>
