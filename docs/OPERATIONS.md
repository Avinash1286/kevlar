...
The v1.0.0 recovery procedure and deletion boundary are documented in [RECOVERY.md](RECOVERY.md). Project deletion is an authenticated owner/admin operation, runs in bounded idempotent batches, redacts raw payloads, and leaves an auditable tombstone.
